...
func TestSafeOutflowBudgetVerifierRejectsDuplicateAuthorityRows(t *testing.T) {
	bound := SafeOutflowBound{Kind: "native", To: "0x2222222222222222222222222222222222222222", MaxAmount: "100"}
	policy := SafeContainmentPolicy{Version: SafeContainmentPolicyVersion, Safe: "0x1111111111111111111111111111111111111111", AllowedOutflow: []SafeOutflowBound{bound, bound}}
