...
// account or transaction signature from being scored as if it were an SPL token
// mint. Unavailable or unresolved classification is never treated as low risk.
...
// classifyRadarAccountObservation is pure so target-type safety remains
// regression-testable without a live RPC dependency.
